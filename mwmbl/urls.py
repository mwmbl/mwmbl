...
from mwmbl.views import home_fragment, curation_fragment, add_url, index, approve, revert_current_curation, CurationDetailView, \
    flag_curation, CurationFlagListView, flag_curation_update
...
urlpatterns = [
    ...
    path('curations', curation_fragment, name="curation_table"),
