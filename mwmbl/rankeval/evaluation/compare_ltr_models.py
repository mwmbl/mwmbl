...
import mwmbl.rankeval.evaluation.evaluate as evaluate_module
...
def run():
    ...
    parser.add_argument("--fraction", type=float, default=0.1, help="Fraction of gold test queries to sample.")
