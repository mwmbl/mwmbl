...
def valid_wasm_bytes():
    ...
    return bytes(
        [
            ...
            0x01,
            0x00,
            0x01,  # Memory section: 1 page minimum
            0x07,
            0x0A,
            0x01,
            0x06,
...
def test_submit_valid_wasm_file(client, verified_user, access_token, valid_wasm_bytes):
    ...
    response = client.post("/api/v1/evaluate/submit", {"file": wasm_file}, HTTP_AUTHORIZATION=f"Bearer {access_token}")
...
def test_submit_non_wasm_file(client, access_token):
    ...
    response = client.post("/api/v1/evaluate/submit", {"file": text_file}, HTTP_AUTHORIZATION=f"Bearer {access_token}")
...
def test_submit_large_file(client, access_token):
    ...
    response = client.post("/api/v1/evaluate/submit", {"file": large_file}, HTTP_AUTHORIZATION=f"Bearer {access_token}")
...
def test_submit_without_authentication(client, valid_wasm_bytes):
    ...
    response = client.post("/api/v1/evaluate/submit", {"file": wasm_file})
...
def test_submit_with_unverified_email(client, unverified_access_token, valid_wasm_bytes):
    ...
    response = client.post(
        "/api/v1/evaluate/submit", {"file": wasm_file}, HTTP_AUTHORIZATION=f"Bearer {unverified_access_token}"
    )
...
def test_submit_without_file(client, access_token):
    ...
    response = client.post("/api/v1/evaluate/submit", {}, HTTP_AUTHORIZATION=f"Bearer {access_token}")
...
def test_multiple_submissions_same_user(client, verified_user, access_token, valid_wasm_bytes):
    ...
    response1 = client.post(
        "/api/v1/evaluate/submit", {"file": wasm_file1}, HTTP_AUTHORIZATION=f"Bearer {access_token}"
    )
    ...
    response2 = client.post(
        "/api/v1/evaluate/submit", {"file": wasm_file2}, HTTP_AUTHORIZATION=f"Bearer {access_token}"
    )
