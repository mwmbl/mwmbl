...
def test_urls_with_commas_single_url(client, verified_user, access_token):
    ...
    SearchResultVote.objects.create(user=verified_user, url=url_with_comma, query=query, vote_type="upvote")

    # Test getting vote counts using POST
    vote_stats_request = {"query": query, "urls": [url_with_comma]}
...
def test_urls_with_various_special_characters(client, verified_user, access_token):
    ...
    for i, url in enumerate(special_urls):
        ...
        SearchResultVote.objects.create(user=verified_user, url=url, query=query, vote_type=vote_type)

    # Test getting vote counts using POST
    vote_stats_request = {"query": query, "urls": special_urls}
...
def test_voting_on_url_with_commas(client, verified_user, access_token):
    ...
    vote_data = {"url": url_with_comma, "query": query, "vote_type": "upvote"}
    ...
    vote = SearchResultVote.objects.get(user=verified_user, url=url_with_comma, query=query)
