...
def test_get_meta_description():
    dom = _dom('<html><head><meta name="Description" content="  A short summary.  "></head><body></body></html>')
...
def test_get_first_paragraph_collapses_whitespace_and_nested_tags():
    dom = _dom("<html><body><p>From  <b>Proto-Finnic</b>\n  *kic'as.  Cognate with Finnish.</p></body></html>")
...
def test_crawl_url_falls_back_to_first_paragraph(monkeypatch):
    ...
    html = (
        "<html><head><title>kitsas</title></head><body>"
