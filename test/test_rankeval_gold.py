...
from mwmbl.rankeval.evaluation.evaluate import CLICK_PROPORTIONS, gold_scores_for, latest_ranking
...
def test_gold_scores_take_at_most_ten_results():
    rankings = _rankings([("piles", f"https://result-{i}", i, "2026-01-29") for i in range(1, 16)])
