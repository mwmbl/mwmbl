...
def test_openapi_spec_generation():
    ...
    # The unified docs are now at /api/v1/openapi.json (not per-router)
    ...
    # Check that our voting endpoints are present (mounted under /platform/)
...
def test_openapi_docs_page():
    ...
    # The unified docs page is now at /api/v1/docs
