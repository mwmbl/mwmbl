...
`.github/claude/run.md`, which has the plan reviewed and writes the pull request body. You
need to carry this into it: one paragraph on the approach and why it is split this way,
then the sections with their line estimates. Merging that pull request is what starts
